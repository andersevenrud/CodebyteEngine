...
DrawLib::Surface *      Manager::surface;
Mesh *                  Manager::guiQuad;
Shader *                Manager::guiShader;
GLuint                  Manager::glTexId;
ulong                   Manager::nextElementID;
std::vector<Element*>   Manager::elements;

void Manager::Setup(uint width, uint height){
    if(guiQuad == NULL){
...
void Manager::Resize(uint width, uint height){
    if(surface != NULL) delete surface;
